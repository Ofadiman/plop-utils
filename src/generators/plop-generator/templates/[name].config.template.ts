...
import { ${plopGeneratorConstants.variables.handlebars.name.camelCase}Constants } from './${plopGeneratorConstants.variables.handlebars.name.kebabCase}.constants'
  ...
  prompts: [
    {
      ...
      name: ${plopGeneratorConstants.variables.handlebars.name.camelCase}Constants.variables.base.name,
      type: 'input',
